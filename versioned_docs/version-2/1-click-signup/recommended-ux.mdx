...
At Verified, _signup is what we do._ We are experts in how to optimize onboarding flows to maximize conversion and give users the best possible experience.

The recommended UX below is the result of countless hours of research, design, testing, and development. It is the UX we use ourselves (for example in our upcoming SDK), and we highly recommend you use it as well.
...
But at its core, this guide is very simple. You only need 4 screens ([Phone](#phone), [Verification Code](#verification-code), [Birthday](#birthday), and [Info](#info)) to integrate 1-Click Signup!
:::
...
:::important
**This flow chart shows 1-Click Signup using the [Non-Hosted integration type](/integration-guide?integrationType=non-hosted#integration).** For more information on integration types, see [here](/integration-guide?integrationType=non-hosted#2-configure-brand-settings).
:::
    ...
    <GridRow>
        <GridColumn>
            ...
            <GridNonStickyElement>
                ...
                - With “1-Click Signup”, green logo
