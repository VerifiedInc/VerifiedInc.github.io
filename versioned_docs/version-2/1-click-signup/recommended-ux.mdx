        ...
        <GridColumn>
            ...
            <GridNonStickyElement>
                ...
                - “Verified”:
                    ...
                    - <ColorIndicator color="primary"/> [Primary](#primary) color
                    - Underlined
                ...
                - <ColorIndicator color="primary"/> [Primary](#primary) and <ColorIndicator color="error"/> [error](#error) colors
                - Auto focused
                ...
                - <ColorIndicator color="muted"/> [Muted](#muted) color
                ...
                *Appears when phone number is invalid.*
                ...
                - <ColorIndicator color="error"/> [Error](#error) color

            </GridNonStickyElement>
        </GridColumn>
        <GridColumn>
            <GridStickyElement>
                ![](/img/recommended-ux-screens/phone-empty.png)
                *Starting State* ↗️ [Open in new tab](/img/recommended-ux-screens/phone-empty.png)

                ![](/img/recommended-ux-screens/phone-error.png)
                *Error State* ↗️ [Open in new tab](/img/recommended-ux-screens/phone-error.png)
            </GridStickyElement>
        </GridColumn>
    </GridRow>
    <GridRow>
        ...
        <GridColumn>
            <GridStickyElement>
                ...
                ![](/img/recommended-ux-screens/verification_code-empty.png)
                *Starting State* ↗️ [Open in new tab](/img/recommended-ux-screens/verification_code-empty.png)
                
                ![](/img/recommended-ux-screens/verification_code-error.png)
                *Error State* ↗️ [Open in new tab](/img/recommended-ux-screens/verification_code-error.png)

                ![](/img/recommended-ux-screens/verification_code-resent.png)
                *Resent Code State* ↗️ [Open in new tab](/img/recommended-ux-screens/verification_code-resent.png)
    ...
    <GridRow>
        ...
        <GridColumn>
            <GridStickyElement>
                ...
                ![](/img/recommended-ux-screens/birthday-empty.png)
                *Starting State* ↗️ [Open in new tab](/img/recommended-ux-screens/birthday-empty.png)
                
                ![](/img/recommended-ux-screens/birthday-error.png)
                *Error State* ↗️ [Open in new tab](/img/recommended-ux-screens/birthday-error.png)
    ...
    <GridRow>
        ...
        <GridColumn>
            <GridStickyElement>
                ...
                ![](/img/recommended-ux-screens/info-view-tooltip_hidden.png)
                *View State* ↗️ [Open in new tab](/img/recommended-ux-screens/info-view-tooltip_hidden.png)
                
                ![](/img/recommended-ux-screens/info-view-tooltip_visible.png)
                *Modal State* ↗️ [Open in new tab](/img/recommended-ux-screens/info-view-tooltip_visible.png)

                ![](/img/recommended-ux-screens/info-edit.png)
                *Edit State* ↗️ [Open in new tab](/img/recommended-ux-screens/info-edit.png)

                ![](/img/recommended-ux-screens/info-manual_signup.png)
                *Manual Signup State* ↗️ [Open in new tab](/img/recommended-ux-screens/info-manual_signup.png)
