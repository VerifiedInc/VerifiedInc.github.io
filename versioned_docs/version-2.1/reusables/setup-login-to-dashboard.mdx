...
<details>
    ...
    Set up multi-factor authentication with an authenticator app. This is optional until you request approval for [Production](/api-reference/environments) access, at which point it's required.
