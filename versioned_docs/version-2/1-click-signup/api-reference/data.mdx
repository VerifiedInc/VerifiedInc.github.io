...
<CollapsibleSection>
<CollapsibleHeader>
### Credit Card <Chip label="Add On" variant="outlined" size="small" color="primary"/> {#financials}
</CollapsibleHeader>
...
<CollapsibleSection>
<CollapsibleHeader>
### Employment <Chip label="Add On" variant="outlined" size="small" color="primary"/> {#employment}
</CollapsibleHeader>
...
<CollapsibleSection>
<CollapsibleHeader>
### Vehicles <Chip label="Add On" variant="outlined" size="small" color="primary"/> {#vehicles}
</CollapsibleHeader>
...
<CollapsibleSection>
<CollapsibleHeader>
### Properties <Chip label="Add On" variant="outlined" size="small" color="primary"/> {#properties}
</CollapsibleHeader>
...
<CollapsibleSection>
<CollapsibleHeader>
### Government IDs <Chip label="Add On" variant="outlined" size="small" color="primary"/> {#government-ids}
</CollapsibleHeader>
...
<CollapsibleSection>
<CollapsibleHeader>
### Demographics <Chip label="Add On" variant="outlined" size="small" color="primary"/> {#demographics}
</CollapsibleHeader>
...
<table>
    ...
    <tr>
        ...
        <td>Unique identifier for a credential</td>
    ...
    <tr>
        <td>Fraud Signals <Chip label="Legacy" variant="outlined" size="small" color="error"/></td>
        <td>`fraudSignals`</td>
        <td>`string`</td>
        <td>
            - Identifiers
...
By default, Verified returns either the Overall Risk Score, Risk Level, and Risk Recommendation, or (if the risk is too high) a [`OCE017` error](./errors#oce017). Other risk signals are optional add ons. To enable them, please ask your Verified support representative or email us at Support@Verified.inc.
...
<table>
    ...
    <tr>
        ...
        <td>
            Number from 0 (low risk) to 600 (medium risk)
        </td>
    ...
    <tr>
        ...
        <td>Overall risk level, considering all identifiers provided. (This is a bucketing of the risk score, where `0`-`200` is `"low"`, `201`-`400` is `"medium-low"`, and `401`-`600` is `"medium"`.)</td>
        <td>
            `"medium"`
        </td>
    </tr>
    <tr>
        ...
        <td>Overall risk recommendation, considering all identifiers provided. (This is a bucketing of the risk level, where `"low"` and `"medium-low"` are `"allow"` and `"medium"` is `"flag"`.)</td>
        <td>
            `"flag"`
        </td>
    </tr>
