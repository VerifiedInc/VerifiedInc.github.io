...
:::important
This use case of issuing credentials for a particular partner is by no means required. However, we have to capabilities to suite this use case if you would like to provide this experience for your partners.
:::
