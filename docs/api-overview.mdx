...
:::info
The Credentials object used as input is slightly different the resultant Credential object in this response body and also found in a <Tip type="presentation"/>  documented in the [Get Shared Credentials](#get-shared-credentials) section.
:::
