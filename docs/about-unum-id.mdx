...
- **[1-Click or Free ID Verification](https://www.unumid.co/solutions/for-companies#1-click-or-free-verification):** Either it's 1-click, or it's on us. 
...
- **[Custom Digital ID Cards](https://www.unumid.co/product/for-companies#issue-digital-id-cards):** We'll pay you for each card you issue. 
...
- **[Supercharge Partnerships](https://www.unumid.co/solutions/for-companies#supercharge-partnerships):** Grow your own network.
...
- **Plug into the Unum ID Network:** Grow your own network.
    - Contact our team, contact@unumid.co, to learn which existing Unum ID relationships can add to your growth in 1-click.
...
### Demos
- **[Hooli Demo](/hooli-demo):** is an open source demonstration implementation of [issuing](https://www.unumid.co/issue) Unum ID digital identity cards which unlocks the [Free IDV](/issuance-guide) offering. 
- **[Kredita Demo](/kredita-demo):** is an open source demonstration implementation of [1-click](https://www.unumid.co/1-click) onboarding.
