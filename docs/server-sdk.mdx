...
### Distribution
The SDK will soon be available via NPM and Yarn, as well as on [GitHub](https://github.com/UnumID/Server-SDK-Typescript).
...
"eccPrivateKey": string // your issuer signing private key
/* NEED OTHER KEY */
```
...
You need to provide the credential `id`, which [`issueCredential`](#issueCredential) returns.
...
- [`verifyEncryptedPresentation`](#verifyEncryptedPresentation)
- [`sendSms`](#sendSms)
- [`sendEmail`](#sendEmail)
...
"eccPrivateKey": string, // your verifier signing private key
