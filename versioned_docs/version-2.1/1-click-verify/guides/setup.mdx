...
<Admonition type="info">
    This setting determines a default value, which you can override anytime by including `format` in the request body of [`POST /1-click/verifications/{uuid}/deliver`](/reference/api/endpoints#post-1-click-verifications-deliver).
</Admonition>
...
<table>
    ...
    <tr>
        <td>Code</td>
        <td>`"code"`</td>
        <td>A one-time code the user types in</td>
        <td>
            <blockquote>
    ...
    <tr>
        <td>Link</td>
        <td>`"link"`</td>
        <td>A one-time link the user clicks</td>
        <td>
            <blockquote>
    ...
    <tr>
        <td>Code and Link</td>
        <td>`"codeAndLink"`</td>
        <td>Both, with the code first</td>
        <td>
            <blockquote>
                Enter this code to verify for `{Brand Name}`: 111111
                <br/><br/>
    ...
    <tr>
        <td>Link and Code</td>
        <td>`"linkAndCode"`</td>
        <td>Both, with the link first</td>
        <td>
            <blockquote>
                Click this link to verify for `{Brand Name}`: https://1-click.verified.inc/abcd1234
                <br/><br/>
...
<Admonition type="info">
    This setting determines a default value, which you can override anytime by including `redirectUrl` in the request body of [`POST /1-click/verifications/{uuid}/deliver`](/reference/api/endpoints#post-1-click-verifications-deliver).
</Admonition>
...
<Admonition type="info">
    This setting determines a default value, which you can override anytime by including `redirectUserAfter` in the request body of [`POST /1-click/verifications/{uuid}/deliver`](/reference/api/endpoints#post-1-click-verifications-deliver).
</Admonition>
...
{/* TODO: Add this when SDK integration guide exists: [SDK Integration](/1-click-verify/guides/sdk-integration) or  */}
Now, follow the [API Integration](/1-click-verify/guides/api-integration) guide to integrate 1-Click Verify into your application.