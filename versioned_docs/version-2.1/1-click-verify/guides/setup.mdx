...
Now, follow the [SDK Integration](/1-click-verify/guides/sdk-integration) or [API Integration](/1-click-verify/guides/api-integration) guide to integrate 1-Click Verify into your application.