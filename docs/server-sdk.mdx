...
:::note
Auto generated from source documentation can be found [here](https://docs.unum.id/server-sdk-typescript/index.html). Similar documentation for object definitions can be found [here](https://docs.unum.id/types/index.html). In some respects the auto generated documentation is more detailed then this overview page, however less styled.
:::
