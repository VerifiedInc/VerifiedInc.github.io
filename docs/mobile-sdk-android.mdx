...
- Camera (requested when showing QR code scanner)
- Biometrics (requested when creating private keys)
...
The SDK will be given provided by Unum ID as a compiled binary library.
