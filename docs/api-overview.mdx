...
```typescript title="CredentialRequest"
{
  ...
  description?: string // a description of the credential or explanation for why it is being requested. The description will be displayed to users responding to the request
}
```
...
Type reference for:
- [CredentialRequest](https://docs.verified.inc/types/interfaces/credentialrequest.html)
