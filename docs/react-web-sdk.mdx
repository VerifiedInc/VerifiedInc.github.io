...
2.  upload your push notification credentials to Unum ID so we can send push notifications to your mobile app.
...
- Example uses include associating a user in your system with the [DID](/terminology#DID) identifying them in Unum ID and just-in-time credential issuance.
