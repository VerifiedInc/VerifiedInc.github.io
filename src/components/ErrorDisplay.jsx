...
const ErrorDisplay = ({ message, description, additionalInputs, inputAttemptsExceeded, integrationType, whenThisIsReturned, howToHandle, youShouldNeverGetThisError, children: code, sx }) => {
