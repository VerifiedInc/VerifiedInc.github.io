...
2. Create an [endpoint](https://gist.github.com/rsmets/eccfd998473599c6d6b0cc962d10c086) to receive encrypted [Presentation](/terminology#presentation) data from our Identity Engine cloud. 

#### If acting as an [Issuer](terminology#issuer)
1. Create an [endpoint](https://gist.github.com/rsmets/7dfd807dfaefae1ec6a3aa695c69360d) to receive user [DID](/terminology#did) data from our Identity Engine cloud.
2. Create an [endpoint](https://gist.github.com/rsmets/c9a789ebeecda8077105597575efbec9) to receive signed [Subject](/terminology#subject) credential requests from our Identity Engine wallet.
