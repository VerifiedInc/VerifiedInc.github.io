...
:::note
The self service Dashboard *coming soon* will authenticate at the Customer level in order to create and manage <Tip type="brand">brands</Tip>.
:::

**Example:** ACME Bank is the Unum ID customer where their self service dashboard access rights are defined.
