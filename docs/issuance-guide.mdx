...
**[Unum ID](https://www.unumid.co)** enables issuers to provider their users with best in class onboarding with partners. This particular guide only focuses on how and why to become a <Tip type="brand">brand</Tip> that issues Unum ID <Tip type="credential">credentials</Tip>.
