...
import ErrorExampleOce017 from '@site/versioned_docs/version-2/reusables/error-example-oce017.mdx'
...
See [Risk Signals](./data#risk-signals) on the Data page for details about each attribute.
...
When enabled, the risk signals appear in identifiers metadata in a [`1ClickEntity`](#1clickentity) and in an error for the [`OCE017` error code](./errors#oce017):
