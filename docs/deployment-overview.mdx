...
2. Create an [endpoint](https://gist.github.com/UnumIDAdmin/2bffdf092594196beba48ce7738b60fa) to receive encrypted [Presentation](/terminology#presentation) data from our Identity Engine cloud. 

#### If acting as an [Issuer](terminology#issuer)
1. Create an [endpoint](https://gist.github.com/UnumIDAdmin/4548f589140bcd42407cff45d63794e2) to receive user [DID](/terminology#did) data from our Identity Engine cloud.
2. Create an [endpoint](https://gist.github.com/UnumIDAdmin/d76d9fe46e459e529d7f7b6f9319a0b6) to receive signed [Subject](/terminology#subject) credential requests from our Identity Engine wallet.
