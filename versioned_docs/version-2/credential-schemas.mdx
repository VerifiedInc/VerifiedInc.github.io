...
:::tip
Note that each attribute has a `description` and `examples` to help you understand the credential's schema. If you need more detailed information, look at our open source [schema-sdk](https://github.com/VerifiedInc/schema-sdk) [formats](https://github.com/VerifiedInc/schema-sdk/blob/main/src/formats.ts).
:::
