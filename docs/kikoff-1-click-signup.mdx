...
<details>
    ...
    - We ommitted phone, since you'll already have collected that. **We will pass back to you whether the user verified their phone — even if they opt out of sharing additional data — so you don't have to ask them to re-verify it.**
