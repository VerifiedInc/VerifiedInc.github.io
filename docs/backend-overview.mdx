...
In order to become a customer and create Verifier and Issuer API keys for your brand you must reach out to support@verified.inc. _Our self service dashboard is coming soon!_

Please refer to detailed docs for the exact API calls to perform duties as an Issuer or Verifier, however both integration types require interfacing with the Verified Inc public API. 
