...
- can creates a request for the user to share the credentials with your brand much more easily thanks to the default credential requests
:::

:::caution
The same ApiKey necessary to call /1-click grants you and only you access to the encrypted credential data documented in [Get Shared Credentials](#get-shared-credentials). Please keep this key secure.
:::
