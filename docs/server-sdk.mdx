...
This is a lightweight TypeScript SDK that lets your company act as one or more <Tip type="issuer">issuers</Tip> and <Tip  type="verifier">verifiers</Tip>.

**Before you begin:** You need to be registered as Unum ID customer, and you need to register at least one issuer or verifier. (You can register zero to many of each, depending on your use case.) You'll receive issuer and verifier API keys to use with this SDK.
