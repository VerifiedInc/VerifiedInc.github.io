...
<CollapsibleGroup firstSectionExpanded={false}>
    ...
    <CollapsibleSection>
        ...
        **Click the Add Provider button to add a provider with the following fields:**
...
So, if you are only using **1-Click Health** with the the **API** [integration type](#integration-type), you can ignore these settings.
:::
