...
1. Create an endpoint adhering to the OpenApi [specification](https://gist.github.com/UnumIDAdmin/fd75b174b33ff0c5b4de87118cb11188) to receive signed [Subject](/terminology#subject) credential requests from our Identity Engine wallet. This endpoint also handles receiving user [DID](/terminology#did) data from our Identity Engine cloud.
...
2. Create an endpoint adhering to the OpenApi [specification](https://gist.github.com/UnumIDAdmin/2bffdf092594196beba48ce7738b60fa) for receiving encrypted [Presentation](/terminology#presentation) data from our Identity Engine cloud. 
