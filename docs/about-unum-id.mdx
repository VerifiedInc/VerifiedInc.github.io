...
- **[Architecture](/architecture):** overview of Unum ID components and how the interact with each other and our Identity Engine cloud.
...
### Components
- **[Server SDK](/server-sdk):** lets you act as an <Tip type="issuer"/> or <Tip type="verifier"/>.
