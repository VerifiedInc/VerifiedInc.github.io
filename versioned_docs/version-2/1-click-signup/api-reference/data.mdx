...
<table>
    ...
    <tr>
        <td>Fraud Signals <Chip label="Beta" variant="outlined" size="small" color="primary"/></td>
        <td>`fraudSignals`</td>
        <td>`string`</td>
        <td>
            - Identifiers
...
### Fraud Signals <Chip label="Beta" variant="outlined" size="small" color="primary"/>
...
<table>
    ...
    <tr>
        ...
        <td>
            Indicators providing additional context about the transaction: see [Reason Codes](#reason-codes)
        </td>
    </tr>
    <tr>
        <td>
