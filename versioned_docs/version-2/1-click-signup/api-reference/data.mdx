...
:::warning[Email Credential Handling]
...
### Financials <Chip label="Contact Us" variant="outlined" size="small" color="primary"/> {#financials}
...
<table>
    ...
    <tr>
        ...
        <td>`string`</td>
        <td>Any number of (usually 10-12) digits (0-9)</td>
...
### Employment <Chip label="Contact Us" variant="outlined" size="small" color="primary"/> {#employment}
...
### Vehicles <Chip label="Contact Us" variant="outlined" size="small" color="primary"/> {#vehicles}
...
### Properties <Chip label="Contact Us" variant="outlined" size="small" color="primary"/> {#properties}
...
### Government IDs <Chip label="Contact Us" variant="outlined" size="small" color="primary"/> {#government-ids}
...
### Demographics <Chip label="Contact Us" variant="outlined" size="small" color="primary"/> {#demographics}
...
<table>
    ...
    <tr>
        <td>Risk Signals <Chip label="Add On" variant="outlined" size="small" color="primary"/></td>
        <td>`riskSignals`</td>
        <td>`Object`</td>
        <td>
            - Identifiers
