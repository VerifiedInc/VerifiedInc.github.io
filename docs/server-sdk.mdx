...
The optional [`VersionInfo`](https://docs.unumid.co/types/interfaces/versioninfo.html) attribute is where request header requirements are defined in order to use your API. It is also useful for how a <a href="/terminology#subject"><Tip type="subject"/></a>'s [CredentialRequests](https://docs.unumid.co/types/interfaces/subjectcredentialrequests.html) should be routed to your application in order for the corresponding Server SDK version to preform verifications. 

The [VersionInfo](https://docs.unumid.co/types/interfaces/versioninfo.html) is for specifying required headers in order to hit your API. It is also for the inevitable versioning of your API or the Unum SDK. Because we understand there are many viable API versioning strategies using [TargetInfo](https://docs.unumid.co/types/interfaces/targetinfo.html) you can specify exactly how to reach different versions of your API and subsequently the SDK. 
Note: VersionInfo is an optional parameter and if not supplied the `url` attribute will simply be used.

```typescript title="TargetInfo"
{
...
```typescript title="VersionInfo"
{
  target: TargetInfo, // The information of how to target a customer's application to communication with the corresponding Server SDK versions.
  sdkVersion: string // Server SDK version.
}
```
...
The [`VersionInfo`](https://docs.unumid.co/types/interfaces/versioninfo.html) denotes how encrypted <a href="/terminology#presentation"><Tip type="presentation"/></a>s from Unum ID's SaaS, which originate from the Mobile SDK, should be routed to your application in order for the corresponding Server SDK version to preform verifications.
