...
### Setup
In order to use the Verifier Service you will need to create a Verifier in our self service [dashboard](https://dashboard.unumid.co/). *Please reference the [Quick Start](/1-click-or-free-use-case#dashboard) guide for how to use the dashboard.*
