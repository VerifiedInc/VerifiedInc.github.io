...
<Admonition type="tip">
    You'll see in the [endpoint reference](/reference/api/endpoints#post-1-click) for `POST /1-click` that it supports additional inputs including the user's **email, birth date, and SSN4.**
