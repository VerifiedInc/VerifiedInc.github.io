...
import AuthenticationAdmonition from '@site/versioned_docs/version-2/reusables/authentication-admonition.mdx'
...
For full technical details on how to integrate 1-Click Signup, see [Integration Guide](./integration-guide). For more information on integration types, see [Determine integration type](./integration-guide#2-determine-integration-type).
