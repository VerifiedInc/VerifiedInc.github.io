...
> By `TAKING_THIS_ACTION`, I direct `YOUR_BRAND_NAME` to use Verified Inc. to create a digital ID card with my personal information, and I agree to Verified Inc.’s <a href="https://verified.inc/legal#terms-of-use">Terms of Use</a> and acknowledge its <a href="https://verified.inc/legal#privacy-policy">Privacy Policy</a>.
...
3. Make "Terms of Use" and "Privacy Policy" underlined or colored and hyperlinked to <a href="https://verified.inc/legal#terms-of-use">`https://verified.inc/legal#terms-of-use`</a> and <a href="https://verified.inc/legal#privacy-policy">`https://verified.inc/legal#privacy-policy`</a> (respectively).

Here's full example:

> By clicking "Activate", I direct Hooli to use Verified Inc. to create a digital ID card with my personal information, and I agree to Verified Inc.’s <a href="https://verified.inc/legal#terms-of-use">Terms of Use</a> and acknowledge its <a href="https://verified.inc/legal#privacy-policy">Privacy Policy</a>.
