...
### Setup
In order to use the Issuer Service you will need to create a Issuer in our self service [dashboard](https://dashboard.unumid.co/). *Please reference the [Quick Start](/quick-start-guide#dashboard) guide for how to use the dashboard.*
