...
<table>
    ...
    <tr>
        ...
        <td>`eligibility.plan.insuranceType`</td>
        <td>`string`</td>
        <td>[X12 insurance descriptor code](https://x12.org/codes/insurance-descriptor-codes)</td>
        <td>Type for health insurance plan</td>
        <td>`"C1"`</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>`camelCase`</td>
        <td>Whether health insurance plan is in or out of network</td>
        <td>`"in"`</td>
    </tr>
    <tr>
        <td>↳ ↳ Amount</td>
...
<table>
    ...
    <tr>
        ...
        <td>`network`</td>
        <td>`NetworkStatus`</td>
        <td>See [`NetworkStatus`](/reference/api/types#networkstatus)</td>
        <td>Parsed version of `edi_271`</td>
        <td>See `NetworkStatus` [Example](/reference/api/types##example-networkstatus)</td>
    </tr>
    <tr>
        <td>↳ Status</td>
