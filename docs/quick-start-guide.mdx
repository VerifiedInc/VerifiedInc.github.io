...
This guide provides an abbreviated step-by-step guide for how to get setup as an Unum ID <Tip type="issuer"/> and/or <Tip type="verifier"/>. For full technical details, see the documentation for each component.
