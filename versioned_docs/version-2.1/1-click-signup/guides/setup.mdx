...
Now, follow the [SDK Integration](/1-click-signup/guides/sdk-integration) or [API Integration](/1-click-signup/guides/api-integration) guide to integrate 1-Click Signup into your application.