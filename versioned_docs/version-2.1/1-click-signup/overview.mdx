...
2. **Dummy data:** Users may enter dummy data for [challenges](/reference/data/inputs#challenges) (first name, birthday or SSN4) if they don't think entering their real info is necessary. _You can mitigate this by using description text that stresses to users that thye must use their real info._
