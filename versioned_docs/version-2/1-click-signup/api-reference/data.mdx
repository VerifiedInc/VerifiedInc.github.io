...
<table>
    ...
    <tr>
        <td>Fraud Signals <Chip label="Contact Us" variant="outlined" size="small" color="primary"/></td>
        <td>`fraudSignals`</td>
        <td>`string`</td>
        <td>
            - Identifiers
...
- `"customer_otp"`: for the phone identifier based on the customer-provided input phone number
- `null`
