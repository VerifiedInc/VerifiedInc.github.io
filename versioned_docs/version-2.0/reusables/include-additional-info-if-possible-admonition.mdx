...
<Admonition type="tip">
    You'll see in the [endpoint reference](/v2.0/endpoints#post-1-click) for `POST /1-click` that it supports additional inputs: the user's **email, birth date, and SSN4.**
