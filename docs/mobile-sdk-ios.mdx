...
Because the SDK requires camera and biometric/passcode [permissions](#permissions), you need to add desciptions like these to the `Info.plist` file:
...
You can open this on a trigger of your choice. For example, you can create a "Scan QR Code" button that starts the activity when the user clicks it:
