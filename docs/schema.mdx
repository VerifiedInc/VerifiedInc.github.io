...
You can view all of the Unum ID defined credential schemas via https://schema.verified.inc/schema. If you want to know the schema for a particular credential type you can use that same url with the desired credential type in the path. (For example, https://schema.verified.inc/schema/EmailCredential.)
