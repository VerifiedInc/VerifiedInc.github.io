...
If you're using the **API** [integration type](/1-click-signup/guides/setup#integration-type), coverage for the Sex credential is a bit lower than for the other credentials at about **~80% of US adults.** Coverage for your user base may vary.
:::
