...
The [`VersionInfo`](https://docs.unum.id/types/interfaces/versioninfo.html) object is how the Presentations from the Unum ID SaaS, which originates from the Mobile SDK, should be routed to your application in order for the corresponding Server SDK version to preform verifications.
