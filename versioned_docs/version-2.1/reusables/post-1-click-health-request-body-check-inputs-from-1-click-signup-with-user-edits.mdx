```typescript title="Example: Check, Inputs from 1-Click Signup, With User Edits"
{
    // "externalReference": "appointment-1050" // optional: your own reference string, to be included in responses
