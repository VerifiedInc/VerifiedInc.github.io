...
<TabItem value="semi-hosted" label="Semi-Hosted">
    ...
    We recommend automatically submitting the form when both inputs have valid values. _See our [Demo](https://1-click.demo.verified.inc?integrationType=semi-hosted) for an example of this._
