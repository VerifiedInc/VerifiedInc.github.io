...
import SequenceDiagramTextToSignupIntegration from '@site/versioned_docs/version-2.1/reusables/sequence-diagram-text-to-signup-integration.mdx';
        ...
        **Choose when a user should be redirected:**
        ...
        <table>
            ...
            <tr>
                ...
                <td>After we verify the user’s phone number</td>
            </tr>
            <tr>
                <td>Hosted 1-Click Signup</td>
                <td>After we autofill info and have the user confirm it</td>
            </tr>
        </table>
...
:::important
Only the styling settings listed below apply to **Text to Signup**. There are other styling settings that apply to [**1-Click Signup**](/1-click-signup) (if you're using the **SDK** [integration type](#integration-type)). See [here](/1-click-signup/guides/setup#styling-settings) in the 1-Click Signup Setup guide for details.
:::
...
<CollapsibleGroup firstSectionExpanded={false}>
    ...
    <CollapsibleSection>
        ...
        <SequenceDiagramTextToSignupIntegration/>
...
:::warning
**We do _not_ recommend putting the call to action somewhere where a user may have intermittent or no cell service,** for example in a subway car. Text to Signup requires a user to send and receive an SMS and load a web page, so they need to have reliable service.
:::
...
The color of the graphic depends on the [graphic color](/text-to-signup/guide#styling-settings) styling setting.
