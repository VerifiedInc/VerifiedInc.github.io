...
Have your client call your server to create a session key. The server should use your Verified API key to call [`POST /sessionKey`](../api-reference/endpoints#post-sessionkey).
