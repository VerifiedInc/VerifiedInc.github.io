...
<table>
  <tr>
    <th>`messsage`</th>
    <td>`"1-Click Conflict Request for this Phone Number, Please Try Again"`</td>
  </tr>
</table>
...
<table>
  <tr>
    <th>`messsage`</th>
    <td>`"1-Click Blocked: Risk Score Too High"`</td>
  </tr>
</table>

### `OCE018`

> 1-Click Error: Maximum code attempts exceeded.

<table>
  <tr>
    <th>`messsage`</th>
    <td>`"Maximum code attempts exceeded. Please start a new 1-click flow."`</td>
  </tr>
</table>
...
> 1-Click Error: Maximum birthDate attempts exceeded.

<table>
  <tr>
    <th>`messsage`</th>
    <td>`"Maximum birthDate attempts exceeded. Please try again later."`</td>
  </tr>
</table>

### `OCE020`

> 1-Click Error: API is being miss used for your integration type.

<table>
  <tr>
    <th>`messsage`</th>
    <td>`"1-Click API is being miss used for your integration type."`</td>
  </tr>
</table>