...
import UpdateProductionBaseUrlAndApiKey from '@site/versioned_docs/version-2.0/reusables/update-production-base-url-and-api-key.mdx'
...
Ensure you've completed the items in the [Go Live checklist](/v2.0/./integration-guide#go-live) in the Integration Guide.
