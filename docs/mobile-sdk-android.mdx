...
```java
UnumId.configure(new UnumSDKConfig(true, false));
```
</TabItem>
</Tabs>
...
In the context of Unum ID, a **deep link** is a URL that opens a specific <Tip type="holder app"/>. For example, a link that opens the ACME mobile app might look like this:
