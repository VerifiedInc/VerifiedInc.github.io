...
Use these test users to go through successful 1-Click Signup flows (where Verified returns [credentials](/reference/data#credentials)). 


### Phone Only

For these users, only a phone number is needed to source [credentials](/reference/data#credentials).
...
Use this user to specifically test the low risk case of [risk signals metadata](/reference/data#risk-signals). _Compare it to the [medium risk (flagged)](#flagged) and [high risk (blocked)](#blocked) test users._
...
Use this user to specifically test the medium risk case of [risk signals metadata](/reference/data#risk-signals). _Compare it to the [low risk (allowed)](#allowed) and [high risk (blocked)](#blocked) test users._
...
For these users, both a phone number and additional information is needed to source [credentials](/reference/data#credentials). 
...
For this user, both a phone number and either a birth date or SSN4 is needed to source [credentials](/reference/data#credentials).
...
Use these test users to write specific cases for [credential](/reference/data#credentials) data, if it's relevant to your use case.
...
Use these test users to go through unsuccessful 1-Click Signup flows (where Verified does _not_ return [credentials](/reference/data#credentials)). 
...
Use this user to specifically test the high risk case of [risk signals metadata](/reference/data#risk-signals). _Compare it to the [low risk (allowed)](#allowed) and [medium risk (flagged)](#flagged) test users._
