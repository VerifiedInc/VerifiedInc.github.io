...
When you register a <Tip type="holder app"/>, we will send you a GitHub personal access token. Create a github.properties file within in the root
...
It is suggested to add this file to .gitignore so it is not committed to your repo.
