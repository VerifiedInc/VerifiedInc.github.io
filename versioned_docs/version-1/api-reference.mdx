...
The core functionality of our API allows your brand to participate in the Verified Network through [1-Click Signup](/). For more advanced use cases like [Issue to Earn](/issue-to-earn), please refer to our [advanced](#advanced-functionality) API section.
