...
import CredentialRequestTableSemiHostedAndNonHosted from '@site/versioned_docs/version-2.0/reusables/credential-request-table-semi-hosted-and-non-hosted.mdx'
import OneClickEntityExample from '@site/versioned_docs/version-2.0/reusables/1-click-entity-example.mdx'
import ErrorType from '@site/versioned_docs/version-2.0/reusables/error-type.mdx'
import ErrorExampleOce011 from '@site/versioned_docs/version-2.0/reusables/error-example-oce011.mdx'
import ErrorExampleOce017 from '@site/versioned_docs/version-2.0/reusables/error-example-oce017.mdx'
...
<table>
    ...
    <tr>
        ...
        <td>`Object`</td>
        <td>See above</td>
        <td>User [identifiers](/reference/data/#identifiers), keyed on `identifierKey`</td>
    ...
    <tr>
        ...
        <td>
            <details>
                ...
                Possible values (see [identifiers](/reference/data/#identifiers) for details):
                    - `phone`
                    - `email`
            </details>
        </td>
    ...
    <tr>
        ...
        <td>`Object`</td>
        <td>See above</td>
        <td>User [credentials](/reference/data/#credentials), keyed on `credentialKey`</td>
        <td>See [Example `1ClickEntity`](#example-1clickentity)</td>
    </tr>
    <tr>
        <td>`credentialKey`</td>
        <td>
            <details>
                ...
                Possible values (see [credentials](/reference/data/#credential) for details):
                    - `phone`
                    - `email`
                    - `fullName.firstName`
                    - `fullName.middleName`
    ...
    <tr>
        ...
        <td>`Object`</td>
        <td>See above</td>
        <td>[Metadata](/reference/data/#metadata), keyed on `metadataKey`</td>
        <td>See [Example `1ClickEntity`](#example-1clickentity)</td>
    </tr>
    <tr>
        <td>`metadataKey`</td>
...
See [Risk Signals](/reference/data#risk-signals) on the Data page for details about each attribute.
