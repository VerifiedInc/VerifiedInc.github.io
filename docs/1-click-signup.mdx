...
sequenceDiagram
    ...
    rect rgb(200,200,200,0.25)
        note left of C: 1. Call 1-Click Endpoint
        C->>+V: Call POST /1-click with phone number, isHosted false, and DOB
...
*Please note that same as in the hosted flow, Verified Inc. will still sending the SMS on your behalf in Sandbox, however the same [go live](/#go-live) checklist applies and you will need handle the SMS in Production.*