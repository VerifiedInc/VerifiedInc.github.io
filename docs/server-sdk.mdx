...
You need to be able to receive these credential requests from Unum ID and pass them to this function. To do this, you need to create a `/credentialRequest` endpoint that conforms to our [OpenAPI specification](https://gist.github.com/rsmets/c9a789ebeecda8077105597575efbec9). 
...
:::important
The SubjectCredentialRequest array ought to be able to be passed as is from the specified OpenApi [/credentialRequest](https://gist.github.com/rsmets/c9a789ebeecda8077105597575efbec9) endpoint.
:::
