...
<div class='two-column-grid-container'>
  <div class='two-column-grid-row'>
    <div class='two-column-grid-column'>
      ![](/img/phone-empty-without-sms-consent.png) _Verified consent language, phone number input, and the green signup variant of the "powered by" graphic_
    </div>
    <div class='two-column-grid-column'>
...
<TabItem value="first-name" label="First Name" default>
  ...
  See the [First Name](/1-click-signup/user-experience#first-name) screen of our User Experience guide for our detailed recommendations.
...
<TabItem value="birth-date" label="Birth Date">
  ...
  See the [Birthday](/1-click-signup/user-experience#birthday) screen of our User Experience guide for our detailed recommendations.
