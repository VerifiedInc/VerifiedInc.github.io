...
:::note
Auto generated SDK documentation can be found [here](https://docs.unumid.co/server-sdk-typescript/index.html). Similar documentation for object definitions can be found [here](https://docs.unumid.co/types/index.html). The auto generated documentation is more granular then this page, however less styled.
:::
...
The optional [VersionInfo](https://docs.unumid.co/types/interfaces/versioninfo.html) attribute is where request header requirements are defined in order to use your API. It is also useful for how a <a href="/terminology#subject"><Tip type="subject"/></a>'s [CredentialRequests](https://docs.unumid.co/types/interfaces/subjectcredentialrequests.html) should be routed to your application in order for the corresponding Server SDK version to preform verifications. This can be updated at later point from the Unum ID [dashboard](https://dashboard.sandbox-unum.id/#/login). If not supplied simply the `url` attribute will be used.
...
#### Response Body: [`VerifiedStatus`](https://docs.unumid.co/server-sdk-typescript/interfaces/verifiedstatus.html)
