...
:::tip
**Complete this Setup guide before following the 1-Click Signup [SDK Integration](/1-click-signup/guides/sdk-integration) or [API Integration](/1-click-signup/guides/api-integration) guide.**
:::
...
<details>
    ...
    <table>
        <tr>
            <th>Setting</th>
            <th>Relevant to Integration With</th>
            <th>Options</th>
            <th>Default</th>
            <th>Description</th>
            <th>Example</th>
...
:::important
Styling settings only apply to **1-Click Signup** using the **SDK** because they affect the user interface the SDK displays. (They also apply to [**Text to Signup**](/text-to-signup).)
...
Now, follow the [SDK Integration](/1-click-signup/guides/sdk-integration) or [API Integration](/1-click-signup/guides/api-integration) guide to integrate 1-Click Health into your application.