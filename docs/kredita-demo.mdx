...
## Web Demo
The live Kredita web application demo can be found [here](https://kredita-web.demo.sandbox-verifiedinc.com/login). Its open source code can be found on [Github](https://github.com/UnumID/Kredita-Demo-Web). 
