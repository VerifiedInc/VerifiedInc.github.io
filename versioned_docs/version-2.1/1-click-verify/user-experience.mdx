...
**Our SDK implements this user experience, and we strongly recommend you use it by choosing the SDK [integration type](/1-click-verify/guides/setup#integration-type).** If you instead choose the **API** integration type, we recommend you implement a user experience similar to this one.
:::
