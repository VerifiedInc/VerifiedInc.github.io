...
### How to Request Production Approval

To request production approval, follow these steps:
1. Navigate to the **Brand Details** page in the [Dashboard](https://dashboard.verified.inc/brands).
2. Switch to the **PRODUCTION** environment.
3. Click on the **REQUEST APPROVAL** button in the **Approval Required** alert.
