...
**If necessary, click the star icon button to set one provider as the default.** You can override this default by specifying a different provider `npi` in the request body of [`POST /1-click/health`](/reference/api/endpoints#post-1-clickhealth): see the [API Integration](/1-click-health/guides/api-integration) guide for details.
