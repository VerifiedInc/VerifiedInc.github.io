...
slug: /reference/api/authentication
...
Your company account can have one or more brands, and each brand can have one or more API keys. Each API key is specific to a brand and an [environment](/reference/api/environments).
