    ...
    <CollapsibleSection>
        ...
        **Choose which challenge(s) to allow:**
        ...
        <table>
            ...
            <tr>
                <td>First Name only <Chip label="Recommended" variant="outlined" size="small" color="primary"/></td>
                <td>Prompt the user for their first name only — never their birthday or SSN4.</td>
            </tr>
            <tr>
                <td>Birthday only <Chip label="Recommended" variant="outlined" size="small" color="primary"/></td>
                <td>Prompt the user for their birthday only — never their first name or SSN4.</td>
            </tr>
            <tr>
                <td>SSN4 only</td>
                <td>Prompt the user for their SSN4 only — never their first name or birthday.</td>
            </tr>
            <tr>
                <td>Birthday or SSN4</td>
                <td>Prompt the user for their first name, birthday, SSN4, or multiple (only if necessary, in that order).</td>
            </tr>
        </table>

        <details>
            <summary>Why We Recommend <b>First Name only</b> and <b>Birthday only</b></summary>
