...
You only need to display the user's [**credential**](./types#credentials) data (their identity data) to them. You don't need to display any [**metadata**](./types#metadata), though you can choose to if it's relevant.
