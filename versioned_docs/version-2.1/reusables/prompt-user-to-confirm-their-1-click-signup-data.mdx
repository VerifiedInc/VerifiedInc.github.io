...
<Admonition type="danger" title="Mask Social Security Numbers">
    **We require you to mask Social Security Numbers because they're particularly sensitive:**
    ...
    - **If you allow the user to edit the SSN, clear the entire value when they start editing**, so they don't just edit the last 4 digits (which could result in another valid SSN, but one that isn't theirs).
</Admonition>
