...
## Issuer
To perform the duties of an <Tip type="issuer">Issuer</Tip> we still require the Server SDK to be used on our backend and that you manage your own private keys.
