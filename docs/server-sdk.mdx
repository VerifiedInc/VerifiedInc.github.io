...
:::important
The SubjectCredentialRequest array ought to be able to be passed as is from the specified OpenApi [/userCredentialRequests](https://gist.github.com/UnumIDAdmin/fd75b174b33ff0c5b4de87118cb11188) endpoint.
:::
