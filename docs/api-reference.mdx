...
7. (Optional) isHosted. _If you would like to do the [non-hosted](/#non-hosted-1-click-signup) integration ._
8. (Optional) birthDate. _Only required if you are using the [non-hosted](/#non-hosted-1-click-signup) integration._
