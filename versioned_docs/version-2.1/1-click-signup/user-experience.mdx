    ...
    <GridRow>
        <GridColumn>
            ...
            <GridNonStickyElement>
                ...
                > By entering your phone number, you agree that [Verified](https://verified.inc) (`{Brand Name}`'s service provider) and its vendors may receive your personal info and autofill more info about you, including your social security number.

                If your [credential requests](/1-click-signup/guides/setup#default-credential-requests) do not include SSN, "including your social security number" will be omitted.
    ...
    <GridRow>
        <GridColumn>
            ...
            <GridNonStickyElement>
                ...
                *Appears when there's a [first name mismatch error](/reference/api/errors#oce012) (`OCE012`).*
        ...
        <GridColumn>
            ...
            <GridNonStickyElement>
                ...
                *Appears in view state.*
                ...
                - “Birthday” not “Birth Date” because the former is friendlier
                - Year digits masked (server side), unless user entered these as input
                ...
                *Appears in view state.*
                ...
                - First 5 digits masked (server side)
