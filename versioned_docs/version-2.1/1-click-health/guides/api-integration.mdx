...
If you configured the [webhooks](/1-click-health/guides/setup#webhooks) setting in the Verified Dashboard, we'll send the 1-Click Health response as a [payload](/reference/webhooks#payload) to your webhook.
