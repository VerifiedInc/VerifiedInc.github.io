...
3. data about the person or a set of credentials
...
Example credential with a set of credentials
...
The full details of the request object aren't that important or helpful to know, as it's completely internal to Verified Inc., but here's an example of a request for a SsnCredential and FirstName credential from the same issuing brand.
