...
> This page serves as a more detailed walkthrough than what can be found in the [Quick Start Guide](/1-click-or-free-use-case) for how to implement and qualify for Free IDV with Unum ID.
