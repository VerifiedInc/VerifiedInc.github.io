...
:::tip
**We've included helpful tooltips** like <Tip text="Whoa, a tooltip! 😎">this one</Tip> (hover over it) throughout the docs. These offer quick definitions, examples, and links to dive in deeper. They often refer to the terms described in full detail here (for example: <Tip type="credential"/>).
:::
