...
<table>
    ...
    <tr>
        <td>↳ ↳ `benefits[i].serviceTypeCodes[j]`</td>
        <td>`string`</td>
        <td>1+ characters</td>
        <td>[X12 service type code](https://x12.org/codes/service-type-codes) for health insurance plan</td>
        <td>`"30"`</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>↳ ↳ `contacts[i].serviceTypeCodes[j]`</td>
        <td>`string`</td>
        <td>1+ characters</td>
        <td>[X12 service type code](https://x12.org/codes/service-type-codes) relevant to contact for health insurance plan</td>
        <td>`"30"`</td>
    </tr>
    <tr>
