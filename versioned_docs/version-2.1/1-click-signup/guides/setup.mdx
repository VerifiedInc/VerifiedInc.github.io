...
<table>
    ...
    <tr>
        ...
        <td>Medium High (1-2 weeks)</td>
        <td>You use our API only and build everything yourself</td>
    </tr>
</table>

:::note Looking for Hosted, Semi-Hosted, or Non-Hosted?
**Hosted,** **Semi-Hosted,** and **Non-Hosted** are integration types [in v2.0](/v2.0/integration-guide#2-configure-brand-settings) but not in v2.1. _**Non-Hosted** in v2.0 is equivalent to **API** in v2.1._
:::

<Admonition type="tip" title="We Strongly Recommend the SDK Integration Type">
    **The SDK integration type is by *far* the easier option, and we strongly recommend using it.** The SDK handles almost everything for you and is highly customizable, so you can use it to exactly match your branding and desired user experience. It implements our recommended [user experience](../guides/user-experience), which is hyper optimized from our experience verifying millions of users.
...
:::note Definition
[**Risk signals**](../data#risk-signals) are metadata that enhance 1-Click Signup's anti-fraud capabilities.
:::
...
<table>
    ...
    <tr>
        ...
        <td>Include all risk signals.</td>
    </tr>
    <tr>
...
Choose which [credentials](../data#credentials) Verified should try to source about the user:
...
<details>
    ...
    <table>
        ...
        <tr>
            <td>Field Type</td>
            <td>SDK and API</td>
            <td>[Credential](../data#credentials) type</td>
            <td>-</td>
