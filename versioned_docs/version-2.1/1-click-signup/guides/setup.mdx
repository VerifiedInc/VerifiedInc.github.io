...
<table>
    ...
    <tr>
        ...
        <td>Custom JSON</td>
        <td>-</td>
        <td>Custom JSON configuration that allows fine-grained control over any SDK component styling. It laverages MUI's theme system. [Learn more](https://mui.com/material-ui/customization/default-theme)</td>
    </tr>
</table>
