...
<table>
    ...
    <tr>
        <th>Coverage</th>
        <td>~80% of US adults (>226M people)</td>
    </tr>
    <tr>
...
**1-Click Health autofills health insurance for a user and runs eligibility checks for it,** so the user can onboard with insurance in less than 30 seconds.
